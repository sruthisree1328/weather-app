$('#weather-Btn').click(() => {
    ...
    $.ajax({
        type: 'GET',
        url: `http://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=8c698b9c6d9f10c7e3fe1fe6eecef1f1`,
        success: (data) => {
            console.log('In success callback');
            console.log(data);
            const currentTemperature = Math.round(data.main.temp - 270);
...
$('#forecast-Btn').click(() => {
    ...
    $.ajax({
        type: 'GET',
        url: `http://api.openweathermap.org/data/2.5/forecast?q=${cityName}&appid=8c698b9c6d9f10c7e3fe1fe6eecef1f1`,
        success: (data) => {
            console.log('In success callback');
            console.log(data);
